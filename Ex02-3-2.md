...
この作業を行う前にリストア対象の Azure Storage アカウント の任意のコンテナー内の BLOB を削除しておいてください。
...
StorageAccount_Restore_anotherStorage.png



StorageAccount_restore_container.png
...
StorageAccount_restore_paramater.png


StorageAccount_restore_point.png

StorageAccount_RestorePoint.png

Restore_parametor.png

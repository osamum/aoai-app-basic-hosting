...
1. 以下の内容をメモ帳などのテキストエディタに貼り付け、環境変数の設定の中身をコメントに従い書き換えます
    ...
    resource appSettings 'Microsoft.Web/sites/config@2022-03-01' = {
     ...
     properties: {
        ...
        'LM_SETTINGS' : '{"deploymentName":"gpt-5-chat", "apiVersion":"2025-04-01-preview", "conversationLength":"10", "tokenLimit":"20000"}'
        'IMAGE_GENERATOR_SETTINGS' : '{"deploymentName":"", "apiVersion":"", "imageSize":"1024x1024","imageStyle":"vivid"}'
        'EMBEDDING_SETTINGS' : '{"deployName":"text-embedding-3-small", "apiVersion":"2023-05-15"}'

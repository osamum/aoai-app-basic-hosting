...
1. 以下の内容をメモ帳などのテキストエディタに貼り付け、環境変数の設定の中身をコメントに従い書き換えます
    ...
    resource appSettings 'Microsoft.Web/sites/config@2022-03-01' = {
     ...
     properties: {
        ...
        'LM_SETTINGS' : '{"deploymentName":"gpt-4o-mini", "apiVersion":"2024-12-01-preview", "conversationLength":"10", "tokenLimit":"20000"}'
        'IMAGE_GENERATOR_SETTINGS' : '{"deploymentName":"dall-e-3", "apiVersion":"2024-02-01", "imageSize":"1024x1024","imageStyle":"vivid"}'

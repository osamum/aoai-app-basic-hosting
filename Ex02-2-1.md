# 演習 2-2-1 : App Service ログの設定と有効化
...
8. ダウンロードされた zip ファイル内の `<日付データ>_default_docker.log` ファイルを開き、ログストリームと同じ内容が記録されていることを確認します
...
👉　[**演習 2-2-2 : Azure OpenAI のメトリックの表示**](Ex02-2-2.md)

---

👈　[演習 2-2 : ログの有効化と取得について](Ex02-2.md)

...
Azure Cloud Shell からコマンドを使用してリソースグループを作成し、その後、 **Bicep** を使用して Azure リソースを**自動作成**します。
...
なお、上記の手順は [Azure OpenAI アプリケーション開発ハンズオン](https://github.com/osamum/AOAI-first-step-for-Developer)コンテンツに遷移するので、接続情報をメモしたら**次の演習には進まずに**このページに戻ってきてください。
